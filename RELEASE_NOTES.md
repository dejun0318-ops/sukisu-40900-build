...
The kernel uses SukiSU builtin commit `b20dee702035af09cb2ecb5f35443bbc1747f3e6` (v4.2.0 plus a build fix), with the kernel version set to 40900. It uses SUSFS commit `596ec8fcdcb5a6ee366494304333c7fdc76d8862` and Android GKI branch `common-android14-6.1-2025-06`.
